...
class GestureExecutor(
    ...
    private fun requireService(op: String): DrishtiAccessibilityService? {
    ...
    private fun findFocusedEditable(service: DrishtiAccessibilityService): AccessibilityNodeInfo? {
    ...
    private fun findScrollable(service: DrishtiAccessibilityService): AccessibilityNodeInfo? {
...
private fun DrishtiAccessibilityService.displaySize(): Pair<Int, Int> {
