...
import com.clicky.ai.SarvamClient
import com.clicky.ai.Speaker
import com.clicky.ai.Transcriber
import com.clicky.ai.TranscriptionResult
import com.clicky.debug.RingBufferLogger
import com.clicky.overlay.BubbleState
...
class VoiceCoordinator @Inject constructor(
    ...
    private fun startListening() {
        if (!recorder.hasRecordPermission()) {
            ...
            toast("Grant microphone permission in Clicky, then tap the bubble")
            runCatching {
